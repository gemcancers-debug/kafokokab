...
تاریخ: 2026-08-13
آخرین تغییر: 2026-08-14 - اضافه شدن allCityNames برای لیست انتخاب‌گر
...
object IranCities {
    ...
    /**
     * لیست نام تمام شهرهای موجود برای انتخاب‌گر UI.
     */
    fun allCityNames(): List<String> = cities.map { it.name }
